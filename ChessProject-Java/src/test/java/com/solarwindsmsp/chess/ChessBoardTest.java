...
public class ChessBoardTest extends TestCase {
    ...
    @Test
    public void Avoids_Duplicate_Positioning() throws IllegalBoardPlacementException {
    ...
    @Test
    public void testLimits_The_Number_Of_Pawns() throws IllegalBoardPlacementException {
        for (int i = 0; i < 10; i++)
        {
            ...
            try {
                ...
                System.out.println("Failed to add pawn due to incorrect piece position");
            }
            if (row < 1)
            {
