...
public class ChessBoardTest extends TestCase {
    ...
    public void testIsLegalBoardPosition_False_X_equals_11_Y_equals_5() {
        ...
        assertFalse(isValidPosition); // Changed this, the xCoordinate can't be 11, alternatively I could have modified the above line
    }
    ...
    public void testAvoids_Duplicate_Positioning() {
        ...
        testSubject.addPiece(firstPawn, 6, 3, PieceColor.BLACK, true);
        testSubject.addPiece(secondPawn, 6, 3, PieceColor.BLACK, true);
    ...
    public void testLimits_The_Number_Of_Pawns()
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            testSubject.addPiece(pawn, 6 + row, i % ChessBoard.MAX_BOARD_WIDTH, PieceColor.BLACK, true);
            if (row < 1)
            {
